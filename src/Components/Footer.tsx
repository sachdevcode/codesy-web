          ...
          <div className="mb-6 md:mb-0 flex flex-col gap-4">
            <a href="#" className="flex items-center w-[160px]">
              <img
                ...
                alt="Codesy"
              />
              {/* <span className="self-center text-2xl font-semibold whitespace-nowrap ">Codesy</span> */}
            </a>
            <div className="sm:flex sm:items-start justify-center flex-col-reverse gap-4 ">
